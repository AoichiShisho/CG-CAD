...
public class sketch_11_1 extends PApplet {
...
class Triangle {
  ...
  public void draw(int R, int G, int B) {
    ...
    dz[0]=Depth[1]-Depth[0]; dz[1]=Depth[2]-Depth[1]; dz[2]=Depth[0]-Depth[2];
    ...
    for (int iy=ymin; iy<=ymax; iy++) {
      ...
      if(dy[0]!=0) {
        ...
        if(t>=0.0f&&t<=1.0f) {
          xt=(int)(W0[0]+dx[0]*t);
          zt=Depth[0]+dz[0]*t;
          if(xt<=xs) { xs=xt; zs=zt; }
          if(xt>=xe) { xe=xt; ze=zt; }
        }
      }
...
public void mult(float[][] Ma, float[][]Mb, float[][] Mo) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "sketch_11_1" };
    if (passedArgs != null) {
